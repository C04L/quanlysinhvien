...
export function AuthCompLight() {
    return (
        <div id={"Login card"}
             className={"grid md:grid-cols-2 w-10/12 mx-auto border-[1px] border-black/30 bg-background overflow-hidden rounded-xl md:h-[100%] h-5/6 min-h-96 shadow-gray-600 shadow-2xl"}>
            <div className={"hidden md:block border-border h-full dark:bg-muted bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:14px_24px] [mask-image:radial-gradient(ellipse_90%_75%_at_20%_10%,#000_70%,transparent_110%)]"}>
                <div className={"m-7 h-full"}>
                    <div className={"md:inline-flex hidden self-center min-w-full"}>
                        ...
                        <h1 className={"text-2xl uppercase font-extrabold text-yellow-500 leading-normal my-auto text-nowrap absolute" + inter.className}>Trường
...
export function AuthCompDark() {
    return (
        <div id={"Login card"}
             className={"grid md:grid-cols-2 w-10/12 mx-auto border-[1px] border-white/30 bg-background overflow-hidden rounded-xl md:h-[100%] h-5/6 min-h-96 shadow-gray-600 shadow-2xl"}>
